    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_home:
                startActivity(new Intent(MainNoticiaInterna.this, MainActivity.class));
                return true;
            case R.id.action_curso:
                startActivity(new Intent(MainNoticiaInterna.this, MainSobreCurso.class));
                return true;
            case R.id.action_plan:
                startActivity(new Intent(MainNoticiaInterna.this, MainPlanoCurso.class));
                return true;
            case R.id.action_teachers:
                startActivity(new Intent(MainNoticiaInterna.this, MainProfessores.class));
                return true;
            case R.id.action_office:
                startActivity(new Intent(MainNoticiaInterna.this, MainOffice.class));
                return true;
            case R.id.action_help:
                startActivity(new Intent(MainNoticiaInterna.this, MainHelp.class));
                return true;
            default:
