    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_home:
                startActivity(new Intent(MainPlanoCurso.this, MainActivity.class));
                return true;
            case R.id.action_curso:
                startActivity(new Intent(MainPlanoCurso.this, MainSobreCurso.class));
                return true;
            case R.id.action_plan:
                startActivity(new Intent(MainPlanoCurso.this, MainPlanoCurso.class));
                return true;
            case R.id.action_teachers:
                startActivity(new Intent(MainPlanoCurso.this, MainProfessores.class));
                return true;
            case R.id.action_office:
                startActivity(new Intent(MainPlanoCurso.this, MainOffice.class));
                return true;
            case R.id.action_help:
                startActivity(new Intent(MainPlanoCurso.this, MainHelp.class));
                return true;
            default:
